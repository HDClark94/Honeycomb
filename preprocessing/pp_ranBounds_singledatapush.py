...
def extract_training_dataset(data):
	...
	training_set = [tip_sx, tip_sy, tip_ex, tip_ey, object_sx, object_sy, object_stheta, object_ex, object_ey, object_etheta, sum_ftx, sum_fty, sum_ftt]
	return training_set
...
def json2trainingdata(filepath, shape_db):
	...
	with open(filepath) as data_file:    
		...
		shape_bounds = shape_db.shape_db[shape_id]['ranbounds']
...
def main(argv):
	...
	outputfile= "%s/data_training_with_RanShapeBounds_andForce.json" % argv[1]
