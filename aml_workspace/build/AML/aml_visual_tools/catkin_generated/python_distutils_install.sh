...
echo_and_run cd "/home/irlab/Projects/aml_workspace/src/AML/aml_visual_tools"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/irlab/Projects/aml_workspace/src/AML/aml_visual_tools/setup.py" \
    build --build-base "/home/irlab/Projects/aml_workspace/build/AML/aml_visual_tools" \
    install \
    $DESTDIR_ARG \
