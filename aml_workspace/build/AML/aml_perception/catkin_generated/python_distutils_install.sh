...
echo_and_run cd "/home/irlab/Projects/aml_workspace/src/AML/aml_perception"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/irlab/Projects/aml_workspace/src/AML/aml_perception/setup.py" \
    build --build-base "/home/irlab/Projects/aml_workspace/build/AML/aml_perception" \
    install \
    $DESTDIR_ARG \
